...
You can use a mix of a fixed dimension (a set value or <b>match_parent</b>) as well as <b>wrap_content</b>. When you do this ensure that you set <b>android:adjustViewBounds="true"</b> on the <b>CameraView</b>.
